  ...
  return (
    <Box sx={{ width: "100%", minHeight: "100vh"}}>
      <Grid container className={classes.authGridContainer} >
        <Grid item md={3} className={classes.authGridImage} style={{backgroundColor:"#36393d"}}>
        <Player
          autoplay
          loop
          src="https://assets2.lottiefiles.com/packages/lf20_ev2Tw8UHBw.json"
        ...
        <Player
          autoplay
          loop
          src="https://assets2.lottiefiles.com/datafiles/ugFV3T9Zi676bvx/data.json"
          style={{ height: "300px", width: "300px" }}
        >
